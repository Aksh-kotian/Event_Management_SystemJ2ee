...
public class RegisterServlet extends HttpServlet{
	...
	private void processRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(req.getParameter("register")!=null) {
			...
			String pwd=req.getParameter("pwd");
			String status=rdao.getLogin(pm,pwd);//control going to DAO class
		...
		}//this logout from the account and invalidate the session
			...
			long phone=Long.parseLong(req.getParameter("phone"));
			String status=rdao.updateCustData(id,name,mail,phone);//control going to DAO class
			...
			String status=rdao.addToFeedback(bid,rating,comment);//control going to DAO class
			if(status.equals("exist")) {
